...
![buildStatus](https://img.shields.io/github/workflow/status/theapache64/tpb-cli/Java%20CI%20with%20Gradle?style=plastic)
![latestVersion](https://img.shields.io/github/v/release/theapache64/tpb-cli)
...
```shell script
wget "https://raw.githubusercontent.com/theapache64/tpb-cli/master/install.sh" -q --show-progress -O install.sh && sh install.sh && source ~/.bashrc
```
...
1. Download latest `jar` from [releases](https://github.com/theapache64/tpb-cli/releases/latest/download/tpb-cli.main.jar) 
1. Run `java -jar tpb-cli.main.jar`
